  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{route('admin')}}" class="brand-link">
        <img src="{{url('resources')}}\views\images\icon-cosmetics.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <div class="sidebar">
        ...
        <!-- <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="{{url('resources')}}\views\images\admin.png" class="brand-image img-circle elevation-3" alt="User Image">
          </div>
          <div class="info">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('qLSP')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Quản Lý Sản Phẩm</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{route('qLTH')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Quản Lý Thương Hiệu</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{route('qLNSX')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Quản Lý Nhà Sản Xuất</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{route('dongSP')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('xacNhanDH',['trangThai'=>1])}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Xác Nhận Đơn</p>
                  </a>
                </li>
            ...
            <!-- Quản lý lô hàng -->
            <!-- <li class="nav-item">
              <a href="{{route('qLLH',['barCode'=>'QuanLyLH'])}}" class="nav-link">
